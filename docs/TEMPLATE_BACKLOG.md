...
>
> **Already shipped (50):** `CryptoWeakHash`, `CryptoMathRandom`, `CryptoEcbMode`,
...
> `WebHelmetMissing`, `WebCspMissing`, `WebHstsDisabled`, `WebCorsCredentialsWildcard`,
> `WebReferrerPolicyMissing`, `WebClickjacking`, `WebCacheControlMissing`,
> `PrototypePollutionMerge`, `PrototypePollutionSet`, `InputReqBodyNoValidation`,
> `InputPathTraversal`, `InputRegexDos`, `InputJsonParseNoTryCatch`,
> `FileUploadNoMimeCheck`, `FileReadSync`, `FileTempFileInsecure`,
> `FilePermissionsWorldWritable`, `GoFileCloseErrorIgnored`,
> `SqlStringConcat`, `SqlTemplateString`,
> `TlsMinVersion`, `TlsCertVerifyDisabledNode`, `TlsCertVerifyDisabledGo`,
> `SsrfHttpGetUserInput`, `SsrfFetchUserInput`,
> `DjangoDebugTrue`, `DjangoSecretKeyHardcoded`, `DjangoAllowedHostsWildcard`,
> `DjangoCsrfExempt`, `FlaskDebugTrue`, `FlaskSecretKeyHardcoded`,
> `FlaskSqlAlchemyUriHardcoded`,
> `AwsHardcodedAccessKey`, `AwsS3PublicReadAcl`, `IacDockerLatestTag`,
> `IacDockerAddInsteadOfCopy`,
> `ReactHrefJavascript`, `ReactWindowLocation`, `ReactLocalStorageToken`,
...
- [x] **`SqlStringConcatTemplate`** | **CWE-89** | **Lang:** `JS/TS, Python, Go`
...
- [x] **`SqlTemplateStringTemplate`** | **CWE-89** | **Lang:** `JS/TS`
...
- [x] **`WebHelmetMissingTemplate`** | **CWE-693** | **Lang:** `JS/TS` (Express)
...
- [x] **`WebCspMissingTemplate`** | **CWE-693** | **Lang:** `JS/TS` (Express)
...
- [x] **`WebHstsDisabledTemplate`** | **CWE-319** | **Lang:** `JS/TS` (Express/Helmet)
  - **Trigger:** `helmet({ hsts: false })` or `hsts: { maxAge: 0 }`
  - **Fix Pattern:** Replace with `hsts: { maxAge: 31536000, includeSubDomains: true }`

- [x] **`WebCorsCredentialsWildcardTemplate`** | **CWE-942** | **Lang:** `JS/TS`
...
- [x] **`WebReferrerPolicyMissingTemplate`** | **CWE-200** | **Lang:** `JS/TS` (Express)
...
- [x] **`WebClickjackingTemplate`** | **CWE-1021** | **Lang:** `JS/TS` (Express)
...
- [x] **`WebCacheControlMissingTemplate`** | **CWE-525** | **Lang:** `JS/TS` (Express)
...
- [x] **`PrototypePollutionMergeTemplate`** | **CWE-1321** | **Lang:** `JS/TS`
...
- [x] **`PrototypePollutionSetTemplate`** | **CWE-1321** | **Lang:** `JS/TS`
...
- [x] **`InputReqBodyNoValidationTemplate`** | **CWE-20** | **Lang:** `JS/TS` (Express)
...
- [x] **`InputPathTraversalTemplate`** | **CWE-22** | **Lang:** `JS/TS`
...
- [x] **`InputRegexDosTemplate`** | **CWE-1333** | **Lang:** `JS/TS`
...
- [x] **`InputJsonParseNoTryCatchTemplate`** | **CWE-755** | **Lang:** `JS/TS`
...
- [x] **`FileUploadNoMimeCheckTemplate`** | **CWE-434** | **Lang:** `JS/TS` (Multer/Express)
...
- [x] **`FileReadSyncTemplate`** | **CWE-400** | **Lang:** `JS/TS`
...
- [x] **`FileTempFileInsecureTemplate`** | **CWE-377** | **Lang:** `Python`
...
- [x] **`TlsMinVersionTemplate`** | **CWE-326** | **Lang:** `JS/TS, Go`
...
- [x] **`TlsCertVerifyDisabledNodeTemplate`** | **CWE-295** | **Lang:** `JS/TS`
...
- [x] **`SsrfFetchUserInputTemplate`** | **CWE-918** | **Lang:** `JS/TS`
...
- [x] **`DjangoDebugTrueTemplate`** | **CWE-215** | **Lang:** `Python` (Django)
...
- [x] **`FlaskDebugTrueTemplate`** | **CWE-215** | **Lang:** `Python` (Flask)
...
- [x] **`FlaskSecretKeyHardcodedTemplate`** | **CWE-798** | **Lang:** `Python` (Flask)
...
- [x] **`FlaskSqlAlchemyUriHardcodedTemplate`** | **CWE-798** | **Lang:** `Python` (Flask/SQLAlchemy)
...
- [x] **`AwsHardcodedAccessKeyTemplate`** | **CWE-798** | **Lang:** `JS/TS, Python`
...
- [x] **`AwsS3PublicReadAclTemplate`** | **CWE-732** | **Lang:** `JS/TS, Python`
...
- [x] **`IacDockerLatestTagTemplate`** | **CWE-1104** | **Lang:** `Dockerfile`
...
- [x] **`IacDockerAddInsteadOfCopyTemplate`** | **CWE-706** | **Lang:** `Dockerfile`
...
- [x] **`IacEnvFileHardcodedTemplate`** | **CWE-798** | **Lang:** `Any` (`.env` files)
...
- [x] **`ReactHrefJavascriptTemplate`** | **CWE-79** | **Lang:** `JS/TS` (React)
...
- [x] **`ReactWindowLocationTemplate`** | **CWE-601** | **Lang:** `JS/TS`
...
- [x] **`ReactLocalStorageTokenTemplate`** | **CWE-922** | **Lang:** `JS/TS` (React)
...
- [x] **`ReactUseEffectMissingDepTemplate`** | **CWE-362** | **Lang:** `JS/TS` (React)
